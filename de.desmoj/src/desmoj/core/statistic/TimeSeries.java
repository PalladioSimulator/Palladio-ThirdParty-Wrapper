...
public class TimeSeries extends desmoj.core.statistic.StatisticObject{
    ...
    public void reset() {
        ...
        if(hasToWriteToFile) {
            _file.close();
            _file.open(_fileName); // this will overwrite the already existing file
    ...
    public void update() {
        ...
        if(hasToRecordValues) {
            if(timeValues==null)
                timeValues=new Vector<Double>();
            if(dataValues==null)
                dataValues=new Vector<Double>();
     ...
     */
    public Vector<Double> getDataValues() {
        return dataValues;
    }
     ...
     */
    public Vector<Double> getTimeValues() {
        return timeValues;
    }
