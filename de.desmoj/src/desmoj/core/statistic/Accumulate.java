...
public class Accumulate extends desmoj.core.statistic.ValueStatistics {
    ...
    /**
     * Temporarily suspend data collection, e.g. to exclude the night period in
     * which a plant is closed from influencing machine utilization statistics.
     * Data will be resumed automatically on calling an update(...)-method.       
     */
    public void pause() {
