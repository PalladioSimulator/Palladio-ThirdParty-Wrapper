...
public class Queue<E extends Entity> extends QueueBased implements Iterable<E>{
	 ...
	 * 
	 * @return desmoj.core.Entity : The first entity in the queue or
	 ...
	 * 
	 * @return desmoj.core.Entity : The first entity queued in this queue applying to
     ...
     * The first position is 0, the last one size()-1.
     * 
     * @return desmoj.core.Entity : The <code>Entity</code> at the position of
	 ...
	 * case the queue is empty.
	 * 
	 * @return Entity : The last Entity in the queue or <code>null</code>
	 ...
	 * 
	 * @return Entity : The last Entity queued in this queue applying to
	 *         the given condition or <code>null</code>
	 * @param c
	 *            Condition : The condition that the entity returned must comply
	 *            to
	 */
	public E last(Condition<Entity> c) {
	 ...
	 * is returned.
	 * 
	 * @return Entity : The Entity directly before the given Entity in
	 ...
	 * returned, too.
	 * 
	 * @return Entity : The Entity before the given Entity in the queue
	...
	public void remove(E e) {
		...
		if (!_ql.remove(e)) { // watch out, already removed as a side
			// effect!!!
			sendWarning("Can not remove Entity from Queue!", "Queue : "
					+ getName() + " Method:  void remove(Entity e)",
	 ...
	 * returned.
	 * 
	 * @return Entity : The Entity directly after the given Entity in the
	 ...
	 * 
	 * @return Entity : The Entity after the given Entity in the queue
	 *         complying to the condition or <code>null</code>.
	 * @param e
	 *            Entity : An Entity in the queue
	 * @param c
