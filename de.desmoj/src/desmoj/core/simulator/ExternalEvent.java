...
public abstract class ExternalEvent extends EventAbstract
{
	...
	public void schedule(TimeInstant when) {
        ...
        // generate trace
        this.generateTraceForScheduling(null, null, null, null, null, when);
	...
	public void scheduleAfter(Schedulable after) {
        ...
        // generate trace
        this.generateTraceForScheduling(null, null, null, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime());
	...
	public void scheduleBefore(Schedulable before) {
        ...
        // generate trace
        this.generateTraceForScheduling(null, null, null, null, before, before.getEventNotes().get(0).getTime());
