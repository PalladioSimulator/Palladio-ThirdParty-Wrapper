...
public abstract class EventList {
	/**
	 * Implement this method to let the user obtain a new event-note. This
	 ...
	 * implementation of an event-note is used together with the current active
	 ...
	 * 
	 * @return EventNote : The new event-note that contains all the information
	 ...
	 */
	abstract EventNote createEventNote(Entity who, Event<Entity> what, TimeInstant when);
	...
	/**
	 * Inserts an event-note at the last position in the event-list. Note that
