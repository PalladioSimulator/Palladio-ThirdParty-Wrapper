...
public abstract class Event<E extends Entity> extends EventAbstract {
	...
	public void schedule(E who, TimeInstant instant) {
		...
		// generate trace
		this.generateTraceForScheduling(who, null, null, null, null, instant);
	...
	public void scheduleAfter(Schedulable after, E who) {
        ...
        // generate trace
        this.generateTraceForScheduling(who, null, null, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime());
	...
	public void scheduleBefore(Schedulable before, E who) {
        ...
        // generate trace
        this.generateTraceForScheduling(who, null, null, null, before, before.getEventNotes().get(0).getTime());
     ...
     */  
	protected Event<E> clone() throws CloneNotSupportedException {
