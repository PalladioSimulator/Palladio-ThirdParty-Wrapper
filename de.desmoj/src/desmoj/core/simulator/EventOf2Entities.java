...
public abstract class EventOf2Entities<E extends Entity, F extends Entity> extends EventAbstract {
	...
	public void schedule(E who1, F who2, TimeInstant instant) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, null, null, null, instant);
	...
	public void scheduleAfter(Schedulable after, E who1, F who2) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, null, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime());
	...
	public void scheduleBefore(Schedulable before, E who1, F who2) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, null, null, before, before.getEventNotes().get(0).getTime());
