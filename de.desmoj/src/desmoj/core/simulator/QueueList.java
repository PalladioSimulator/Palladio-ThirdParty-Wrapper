...
public abstract class QueueList<E extends Entity> implements PropertyChangeListener, Iterable<E> {
	 ...
	 * @param e
	 *            Entity : The <code>Entity</code> we are looking for
	 *            in the queue.
	 */
	 ...
	 * 
	 * @return Entity : The first entity in the queue
	 */
	 ...
	 * 
	 * @param e
	 *            Entity : The Entity which will be added to the queue
	 */
	 ...
	 *         <code>false</code> otherwise.
	 * @param e
	 *            Entity : The <code>Entity</code> which will be
	 *            inserted.
	 * @param which
	 *            Entity : The <code>Entity</code> determining the
	 ...
	 * 
	 * @return Entity : The last <code>Entity</code> in the queue.
	 */
	 ...
	 * the queue.
	 * 
	 * @return Entity : The <code>Entity</code> before the given
	 *         <code>Entity</code> "e" in the queue.
	 * @param e
	 *            Entity : The predecessor of this <code>Entity</code>
	 *            will be returned.
	 */
	abstract E pred(E e);
	 ...
	 * @param e
	 *            Entity : The <code>Entity</code> which is to be
	 ...
	 * queue.
	 * 
	 * @return Entity : The <code>Entity</code> after the given
	 *         <code>Entity</code> "e" in the queue.
	 * @param e
	 *            Entity : The successor of this <code>Entity</code>
	 *            will be returned.
	 */
