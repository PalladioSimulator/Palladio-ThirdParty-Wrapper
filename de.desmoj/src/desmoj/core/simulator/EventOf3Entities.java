...
public abstract class EventOf3Entities<E extends Entity, F extends Entity, G extends Entity> extends EventAbstract {
	...
	public void schedule(E who1, F who2, G who3, TimeInstant instant) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, who3, null, null, instant);
	...
	public void scheduleAfter(Schedulable after, E who1, F who2, G who3) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, who3, after, null, after.getEventNotes().get(after.getEventNotes().size()-1).getTime());
	...
	public void scheduleBefore(Schedulable before, E who1, F who2, G who3) {
        ...
        // generate trace
        this.generateTraceForScheduling(who1, who2, who3, null, before, before.getEventNotes().get(0).getTime());
